...
public class LevelManager : MonoBehaviour
{
    ...
    void DisplayHudData()
    {
        uiComponents.hud.txtStarCount.text = "x " + sceneData.starCount;
    ...
    public void ShowLevelCompletePanel()
    {
        ...
        uiComponents.levelCompletePanel.txtScore.text = "" + sceneData.starCount;
    }

    public void ShowGameOverPanel()
    {
        uiComponents.gameOverPanel.panel.SetActive(true);
        uiComponents.gameOverPanel.txtScore.text = "" + sceneData.starCount;
    }
}
